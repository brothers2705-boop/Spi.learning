  ...
  return (
    <div className="min-h-screen bg-[#fcfcf9]">
      ...
      <footer className="border-t border-zinc-200 mt-12 py-6">
        <div className="max-w-[1280px] mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-3 text-[11px] text-zinc-500">
          <div className="flex items-center gap-2"><span className="font-mono">Book view • Real pages • Print-ready</span></div>
