    ...
    <div className="min-h-screen bg-[#fcfcf9] flex items-center justify-center p-6">
      <div className="w-full max-w-[400px]">
        <div className="text-center mb-8">
          <div className="w-10 h-10 rounded-[10px] bg-zinc-900 flex items-center justify-center mx-auto mb-4">
        ...
        <div className="mt-6 text-center text-[11px] font-mono text-zinc-500">
          SPI LEARNING Admin • Separate auth • Test: try /api/admin/jobs without login → 401
        </div>
      </div>
    </div>
  );
