      ...
      <header className="sticky top-0 z-30 border-b border-zinc-200 bg-[#fcfcf9]/80 backdrop-blur-[12px]">
        <div className="max-w-[1280px] mx-auto px-6 h-[64px] flex items-center justify-between">
          <div className="flex items-center gap-8">
            <Link href="/"><Logo size="default" /></Link>
          </div>
      ...
      <footer className="border-t border-zinc-200 py-8 mt-12">
        <div className="max-w-[1280px] mx-auto px-6">
          <div className="flex flex-col md:flex-row items-start justify-between gap-6">
            <div>
              <Logo size="small" />
              <div className="mt-3 text-[12px] text-zinc-600 font-[450] max-w-[320px]">Hours of video. Minutes of notes. Real transcript pipeline, print-ready books.</div>
            </div>
            <div className="flex gap-10 text-[13px] font-[500]">
              <div>
                <div className="text-[11px] font-mono font-[700] tracking-[0.08em] text-zinc-500 mb-2">PRODUCT</div>
                <div className="space-y-1.5">
                  <Link href="/" className="block text-zinc-600 hover:text-zinc-900">Landing — /</Link>
                  <Link href="/app" className="block text-zinc-900 font-[600]">Tool — /app</Link>
                  <a href="https://github.com/brothers2705-boop/Spi.learning" target="_blank" className="block text-zinc-600 hover:text-zinc-900">GitHub</a>
                </div>
              </div>
              <div>
                <div className="text-[11px] font-mono font-[700] tracking-[0.08em] text-zinc-500 mb-2">SHORTCUTS</div>
                <div className="space-y-1 text-[11px] font-mono text-zinc-500">
                  <div>C calc • T timer • M music</div>
                  <div>N notes • L tasks • Ctrl+K</div>
                </div>
              </div>
            </div>
          </div>
          <div className="mt-8 pt-6 border-t border-zinc-100 flex flex-col md:flex-row items-start md:items-center justify-between gap-3">
            <div className="text-[11px] font-mono text-zinc-500 flex items-center gap-2">
              <Logo size="small" />
              <span>• DB: SQLite data/spi.db • Single shared table jobs • userId indexed</span>
              <Link href="/admin/login" className="ml-2 px-2.5 py-1 rounded-full bg-zinc-900 text-white text-[10px] font-[700]">Admin</Link>
            </div>
